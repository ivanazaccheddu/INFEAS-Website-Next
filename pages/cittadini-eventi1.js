...
const ReteEventi = (props) => {
  return (
    <>
      <div className="rete-eventi-container1">
        <Head>
          <title>Rete-Eventi - INFEAS Website</title>
          <meta property="og:title" content="Rete-Eventi - INFEAS Website" />
        </Head>
        <NavbarInteractive
          text={
            <Fragment>
              <span className="rete-eventi-text10">
          ...
          login={
            <Fragment>
              <span className="rete-eventi-text11">Login</span>
            </Fragment>
          }
          text1={
            <Fragment>
              <span className="rete-eventi-text12">Per tutti i cittadini</span>
            </Fragment>
          }
          text2={
            <Fragment>
              <span className="rete-eventi-text13">
          ...
          text3={
            <Fragment>
              <span className="rete-eventi-text14">Mappa CEAS</span>
            </Fragment>
          }
          text4={
            <Fragment>
              <span className="rete-eventi-text15">Press Kit</span>
            </Fragment>
          }
          text5={
            <Fragment>
              <span className="rete-eventi-text16">Seguici su</span>
            </Fragment>
          }
          login1={
            <Fragment>
              <span className="rete-eventi-text17">Cerca</span>
            </Fragment>
          }
          text51={
            <Fragment>
              <span className="rete-eventi-text18">Seguici su</span>
            </Fragment>
          }
          text122={
            <Fragment>
              <span className="rete-eventi-text19">Materiali didattici</span>
            </Fragment>
          }
          register={
            <Fragment>
              <span className="rete-eventi-text20">Register</span>
            </Fragment>
          }
          text1121={
            <Fragment>
              <span className="rete-eventi-text21">A proposito di INFEAS</span>
            </Fragment>
          }
          register1={
            <Fragment>
              <span className="rete-eventi-text22">Cerca</span>
            </Fragment>
          }
          rootClassName="navbar-interactiveroot-class-name39"
        ></NavbarInteractive>
        <Headertipologiatarget
          breadcrumb="Home / Per I membri della Rete / Eventi"
          rootClassName="headertipologiatargetroot-class-name32"
          headerTitleName="Eventi"
        ></Headertipologiatarget>
        <Eventilisting
          rootClassName="eventilistingroot-class-name2"
          eventiListingDestinatario="enti-e-organizzazione-della-rete-infeas"
        ></Eventilisting>
        <LoghiSponsor rootClassName="loghi-sponsorroot-class-name27"></LoghiSponsor>
        <Footer rootClassName="footerroot-class-name37"></Footer>
        <div>
          <div className="rete-eventi-container3">
            <React.Fragment>
              <React.Fragment>
                <style
