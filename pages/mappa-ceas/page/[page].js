...
import organizzazioniPageInitialPropsTqO8Resource from '../../../resources/organizzazioni-page-initial-props-tq_o8'
import organizzazioniPageInitialPathsTqRnResource from '../../../resources/organizzazioni-page-initial-paths-tq_rn'
...
export async function getStaticProps(context) {
  try {
    const response = await organizzazioniPageInitialPropsTqO8Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await organizzazioniPageInitialPathsTqRnResource({})
