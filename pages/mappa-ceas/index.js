...
import organizzazioniPageInitialPropsTqOSResource from '../../resources/organizzazioni-page-initial-props-tq_o-s'
...
export async function getStaticProps(context) {
  try {
    const response = await organizzazioniPageInitialPropsTqOSResource({
      ...context?.params,
    })
    if (!response) {
      return {
