...
import organizzazioniPageInitialPropsTqT7Resource from '../../resources/organizzazioni-page-initial-props-tq_t7'
...
export async function getStaticProps(context) {
  try {
    const response = await organizzazioniPageInitialPropsTqT7Resource({
      ...context?.params,
    })
    if (!response) {
      return {
