...
import organizzazioniPageInitialPropsTqK6Resource from '../../../resources/organizzazioni-page-initial-props-tq_k6'
import organizzazioniPageInitialPathsTqEeResource from '../../../resources/organizzazioni-page-initial-paths-tq_ee'
...
export async function getStaticProps(context) {
  try {
    const response = await organizzazioniPageInitialPropsTqK6Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await organizzazioniPageInitialPathsTqEeResource({})
