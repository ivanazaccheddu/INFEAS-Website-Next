...
import organizzazioniPageInitialPropsTqHTResource from '../../resources/organizzazioni-page-initial-props-tq_h-t'
    ...
    <>
      <main className="organizzazioni1-container1">
        ...
        <NavbarInteractive
          text={
            <Fragment>
              <span className="organizzazioni1-text10">
          ...
          login={
            <Fragment>
              <span className="organizzazioni1-text11">Login</span>
            </Fragment>
          }
          text1={
            <Fragment>
              <span className="organizzazioni1-text12">
          ...
          text2={
            <Fragment>
              <span className="organizzazioni1-text13">
          ...
          text3={
            <Fragment>
              <span className="organizzazioni1-text14">Mappa CEAS</span>
            </Fragment>
          }
          text4={
            <Fragment>
              <span className="organizzazioni1-text15">Press Kit</span>
            </Fragment>
          }
          text5={
            <Fragment>
              <span className="organizzazioni1-text16">Seguici su</span>
            </Fragment>
          }
          login1={
            <Fragment>
              <span className="organizzazioni1-text17">Cerca</span>
            </Fragment>
          }
          text51={
            <Fragment>
              <span className="organizzazioni1-text18">Seguici su</span>
            </Fragment>
          }
          text122={
            <Fragment>
              <span className="organizzazioni1-text19">
                Materiali didattici
              </span>
            </Fragment>
          }
        ...
        <DataProvider
          renderSuccess={(params) => (
            <Fragment>
              <div className="organizzazioni1-container2">
                <Repeater
                  items={params}
        ...
        <section
          ...
          className="organizzazioni1-container3 padding-container"
        >
          <div className="organizzazioni1-container4 thq-section-max-width">
      ...
      <style jsx>
        {`
          ...
          .organizzazioni1-text10 {
            display: inline-block;
          }
          .organizzazioni1-text11 {
            display: inline-block;
          }
          .organizzazioni1-text12 {
            display: inline-block;
          }
          .organizzazioni1-text13 {
            display: inline-block;
          }
          .organizzazioni1-text14 {
            display: inline-block;
          }
          .organizzazioni1-text15 {
            display: inline-block;
          }
          .organizzazioni1-text16 {
            display: inline-block;
          }
          .organizzazioni1-text17 {
            display: inline-block;
          }
          .organizzazioni1-text18 {
            display: inline-block;
          }
          .organizzazioni1-text19 {
            display: inline-block;
          }
          .organizzazioni1-text20 {
            display: inline-block;
          }
          .organizzazioni1-text21 {
            display: inline-block;
          }
...
Organizzazioni1.defaultProps = {
  organizzazioniEntities: [],
}

Organizzazioni1.propTypes = {
  organizzazioniEntities: PropTypes.array,
}

export default Organizzazioni1

export async function getStaticProps(context) {
  try {
    const response = await organizzazioniPageInitialPropsTqHTResource({
      ...context?.params,
    })
    if (!response) {
      return {
