...
import progettoDettaglioPageInitialPropsTqPlResource from '../../resources/progetto-dettaglio-page-initial-props-tq_pl'
import progettoDettaglioPageInitialPathsTqQpResource from '../../resources/progetto-dettaglio-page-initial-paths-tq_qp'
...
export async function getStaticProps(context) {
  try {
    const response = await progettoDettaglioPageInitialPropsTqPlResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await progettoDettaglioPageInitialPathsTqQpResource({})
    return {
