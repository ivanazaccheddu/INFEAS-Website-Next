...
import progettoDettaglioPageInitialPropsTqXdResource from '../../resources/progetto-dettaglio-page-initial-props-tq_xd'
import progettoDettaglioPageInitialPathsTqJEResource from '../../resources/progetto-dettaglio-page-initial-paths-tq_j-e'
...
export async function getStaticProps(context) {
  try {
    const response = await progettoDettaglioPageInitialPropsTqXdResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await progettoDettaglioPageInitialPathsTqJEResource({})
    return {
