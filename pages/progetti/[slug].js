...
import progettoDettaglioPageInitialPropsTqVnResource from '../../resources/progetto-dettaglio-page-initial-props-tq_vn'
import progettoDettaglioPageInitialPathsTq3bResource from '../../resources/progetto-dettaglio-page-initial-paths-tq_3b'
...
export async function getStaticProps(context) {
  try {
    const response = await progettoDettaglioPageInitialPropsTqVnResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await progettoDettaglioPageInitialPathsTq3bResource({})
    return {
