...
import progettoDettaglioPageInitialPropsTqQbResource from '../../resources/progetto-dettaglio-page-initial-props-tq_qb'
import progettoDettaglioPageInitialPathsTq68Resource from '../../resources/progetto-dettaglio-page-initial-paths-tq_68'
...
export async function getStaticProps(context) {
  try {
    const response = await progettoDettaglioPageInitialPropsTqQbResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await progettoDettaglioPageInitialPathsTq68Resource({})
    return {
