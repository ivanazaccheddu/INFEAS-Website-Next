...
import progettoDettaglioPageInitialPropsTqNnResource from '../../resources/progetto-dettaglio-page-initial-props-tq_nn'
import progettoDettaglioPageInitialPathsTqCUResource from '../../resources/progetto-dettaglio-page-initial-paths-tq_c-u'
...
export async function getStaticProps(context) {
  try {
    const response = await progettoDettaglioPageInitialPropsTqNnResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await progettoDettaglioPageInitialPathsTqCUResource({})
    return {
