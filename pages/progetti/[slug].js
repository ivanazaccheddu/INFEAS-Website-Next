...
import progettoDettaglioPageInitialPropsTq1mResource from '../../resources/progetto-dettaglio-page-initial-props-tq_1m'
import progettoDettaglioPageInitialPathsTqK7Resource from '../../resources/progetto-dettaglio-page-initial-paths-tq_k7'
...
export async function getStaticProps(context) {
  try {
    const response = await progettoDettaglioPageInitialPropsTq1mResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await progettoDettaglioPageInitialPathsTqK7Resource({})
    return {
