...
import progettiPageInitialPropsTqFBResource from '../../../resources/progetti-page-initial-props-tq_f-b'
import progettiPageInitialPathsTqP7Resource from '../../../resources/progetti-page-initial-paths-tq_p7'
...
export async function getStaticProps(context) {
  try {
    const response = await progettiPageInitialPropsTqFBResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await progettiPageInitialPathsTqP7Resource({})
