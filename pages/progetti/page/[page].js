...
import progettiPageInitialPropsTqLwResource from '../../../resources/progetti-page-initial-props-tq_lw'
import progettiPageInitialPathsTqCtResource from '../../../resources/progetti-page-initial-paths-tq_ct'
...
export async function getStaticProps(context) {
  try {
    const response = await progettiPageInitialPropsTqLwResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await progettiPageInitialPathsTqCtResource({})
