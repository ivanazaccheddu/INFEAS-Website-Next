...
import progettiPageInitialPropsTqXPResource from '../../resources/progetti-page-initial-props-tq_x-p'
...
export async function getStaticProps(context) {
  try {
    const response = await progettiPageInitialPropsTqXPResource({
      ...context?.params,
    })
    if (!response) {
      return {
