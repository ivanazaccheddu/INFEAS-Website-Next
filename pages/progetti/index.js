...
import progettiPageInitialPropsTqNMResource from '../../resources/progetti-page-initial-props-tq_n-m'
...
export async function getStaticProps(context) {
  try {
    const response = await progettiPageInitialPropsTqNMResource({
      ...context?.params,
    })
    if (!response) {
      return {
