...
import progettiPageInitialPropsTqMAResource from '../../resources/progetti-page-initial-props-tq_m-a'
...
export async function getStaticProps(context) {
  try {
    const response = await progettiPageInitialPropsTqMAResource({
      ...context?.params,
    })
    if (!response) {
      return {
