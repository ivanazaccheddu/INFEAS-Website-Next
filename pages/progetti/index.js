...
import progettiPageInitialPropsTqHIResource from '../../resources/progetti-page-initial-props-tq_h-i'
...
export async function getStaticProps(context) {
  try {
    const response = await progettiPageInitialPropsTqHIResource({
      ...context?.params,
    })
    if (!response) {
      return {
