...
import progettiPageInitialPropsTqXMResource from '../../resources/progetti-page-initial-props-tq_x-m'
...
export async function getStaticProps(context) {
  try {
    const response = await progettiPageInitialPropsTqXMResource({
      ...context?.params,
    })
    if (!response) {
      return {
