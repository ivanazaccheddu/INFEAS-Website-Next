...
import dettaglionotiziePageInitialPropsTq58Resource from '../../resources/dettaglionotizie-page-initial-props-tq_58'
import dettaglionotiziePageInitialPathsTqVbResource from '../../resources/dettaglionotizie-page-initial-paths-tq_vb'
...
export async function getStaticProps(context) {
  try {
    const response = await dettaglionotiziePageInitialPropsTq58Resource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await dettaglionotiziePageInitialPathsTqVbResource({})
    return {
