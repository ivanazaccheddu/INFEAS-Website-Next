...
import notiziePageInitialPropsTq79Resource from '../../../resources/notizie-page-initial-props-tq_79'
import notiziePageInitialPathsTqVeResource from '../../../resources/notizie-page-initial-paths-tq_ve'
...
export async function getStaticProps(context) {
  try {
    const response = await notiziePageInitialPropsTq79Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await notiziePageInitialPathsTqVeResource({})
