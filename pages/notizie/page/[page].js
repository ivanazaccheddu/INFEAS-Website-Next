...
import notiziePageInitialPropsTqWsResource from '../../../resources/notizie-page-initial-props-tq_ws'
import notiziePageInitialPathsTqHhResource from '../../../resources/notizie-page-initial-paths-tq_hh'
...
export async function getStaticProps(context) {
  try {
    const response = await notiziePageInitialPropsTqWsResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await notiziePageInitialPathsTqHhResource({})
