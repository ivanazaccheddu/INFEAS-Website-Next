...
import notiziePageInitialPropsTqL6Resource from '../../../resources/notizie-page-initial-props-tq_l6'
import notiziePageInitialPathsTqQIResource from '../../../resources/notizie-page-initial-paths-tq_q-i'
...
export async function getStaticProps(context) {
  try {
    const response = await notiziePageInitialPropsTqL6Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await notiziePageInitialPathsTqQIResource({})
