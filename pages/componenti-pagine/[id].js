...
import componentiPaginePageInitialPropsTq10Resource from '../../resources/componenti-pagine-page-initial-props-tq_10'
import componentiPaginePageInitialPathsTqR0Resource from '../../resources/componenti-pagine-page-initial-paths-tq_r0'
...
export async function getStaticProps(context) {
  try {
    const response = await componentiPaginePageInitialPropsTq10Resource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await componentiPaginePageInitialPathsTqR0Resource({})
    return {
