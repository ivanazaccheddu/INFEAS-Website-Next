...
import componentiPaginePageInitialPropsTqFqResource from '../../resources/componenti-pagine-page-initial-props-tq_fq'
import componentiPaginePageInitialPathsTqRsResource from '../../resources/componenti-pagine-page-initial-paths-tq_rs'
...
export async function getStaticProps(context) {
  try {
    const response = await componentiPaginePageInitialPropsTqFqResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await componentiPaginePageInitialPathsTqRsResource({})
    return {
